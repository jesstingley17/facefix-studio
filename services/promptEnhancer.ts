...
5. CRITICAL: Add strong facial identity preservation terms (e.g., "identical face", "exact same facial features", "do not alter face", "preserve face exactly", "same person", "no facial changes", "maintain exact facial identity", "copy face precisely", "identical facial structure")
6. Emphasize preserving the exact facial features, structure, and appearance from the reference photo - do not allow any facial modifications
